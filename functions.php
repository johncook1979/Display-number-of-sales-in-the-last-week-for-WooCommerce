/**
  * Display the total number of sales for a product in the last week
  *
  * Place in your theme functions.php file
  *
*/

add_action( 'woocommerce_single_product_summary', 'my_product_sold_count_last_week', 11 );
  
function my_product_sold_count_last_week() {
   global $product;
